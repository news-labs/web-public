...
- [JSON Structure Design](/v1/guides/json-structure-design/) — Dataset·Seed schema details
- [Category Reference](/v1/api/category-reference/) — content_type·nature definitions
